...
> perform code review to your own code
...
```sh
  git clone git@github.com:dagmawiii03/past-review.git
```
...
Feel free to check the [issues page](https://github.com/dagmawiii03/past-review/issues).
...
<p align="right">(<a href="#readme-top">back to top</a>)</p># past-review
